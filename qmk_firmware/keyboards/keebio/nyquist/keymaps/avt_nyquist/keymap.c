...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_4x12(KC_NO, KC_Q, KC_W, KC_E, KC_R, KC_T,                                  KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, \
            			KC_TAB, LSFT_T(KC_A), LCTL_T(KC_S), LALT_T(KC_D), LGUI_T(KC_F), KC_G, KC_H, LGUI_T(KC_J), RALT_T(KC_K), LCTL_T(KC_L), LSFT_T(KC_SCLN), KC_QUOT, \
...
// JMP keys
	[1] = LAYOUT_ortho_4x12(KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                             KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, \
				...
				MAIL_LEXMAIL, KC_1, KC_NO, KC_NO, KC_TRNS, KC_NO, 		      KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, MAIL_STRUCTURA),
