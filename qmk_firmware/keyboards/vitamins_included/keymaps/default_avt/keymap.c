...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______, 		MAIL_LEXMAIL, 	_______, 	_______, 	KC_TRNS,	_______, 	_______,	KC_TRNS,	_______,	_______,	KC_NO, 		_______  \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  KC_MEDIA_NEXT_TRACK, 		KC_TILD, 	KC_GRV, 	KC_NO, 		RESET, 		KC_NO,		KC_UNDS,	KC_MINS,	KC_EXLM,	KC_EQL, 	KC_PLUS,	KC_DEL, \
  KC_MPLY, 			KC_BSLS, 	KC_PIPE,	KC_NO, 		KC_NO, 		KC_NO, 		KC_LBRC,	KC_LCBR,	KC_LPRN,	KC_RPRN,	KC_RCBR,	KC_RBRC, \
  KC_NO, 			KC_NO, 		KC_AT, 		KC_HASH,	KC_DLR, 	KC_PERC, 	KC_CIRC,	KC_AMPR,	KC_ASTR,	KC_NO, 		KC_NO, 		KC_NO, \
  KC_TRNS, 			KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_TAB, 	KC_ESC, 	KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_TRNS \
),
