...
## read from JavaScript is always the global value.
## Type: String
c.content.headers.user_agent = "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:70.0) Gecko/20100101 Firefox/70.0"
...
config.bind('p1', 'spawn --userscript qute-lastpass')
config.bind('p2', 'spawn --userscript qute-lastpass -e')
config.bind('p3', 'spawn --userscript qute-lastpass -w')
